...
public abstract class RecyclerAdapter<Data>
     ...
     *  得到一个新的ViewHolder
     * @param root 根布局
     * @param viewType 布局类型，其实就是XML id
     * @return ViewHolder
     */
     ...
     * @param dataList Data
     */
    //Java中"..." 为可变参数，就是这个位置可以传入 0～任意个该类型参数,你传多少个参数都被放到一个数组里面。
    ...
    /**
     * 设置适配器的监听
     * @param dataAdapterListener AdapterListener
     */
    public void setmListener(AdapterListener<Data> dataAdapterListener){
