...
import net.bj.moetalker.common.app.PresenterToolbarActivity;
...
import net.bj.talker.factory.presenter.contact.PersonalContract;
import net.bj.talker.factory.presenter.contact.PersonalPresenter;
...
public class PersonalActivity extends PresenterToolbarActivity<PersonalContract.Presenter>
     ...
     * 更改关注菜单状态
     */
    private void changeFollowItemsStatus(){
        if(mFollowItem == null)
            return;
