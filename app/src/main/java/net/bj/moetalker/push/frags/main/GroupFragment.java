...
import net.bj.talker.factory.presenter.group.GroupsContract;
import net.bj.talker.factory.presenter.group.GroupsPresenter;
...
public class GroupFragment extends PresenterFragment<GroupsContract.Presenter>
    ...
    protected void initWidget(View root) {
        ...
        //点击事件监听
        mAdapter.setmListener(new RecyclerAdapter.AdapterListenerImpl<Group>() {
            @Override
